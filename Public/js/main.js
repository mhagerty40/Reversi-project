...
/* Handle a notifcation that we have been engaged */
...
{
  /* something weitd is going on, like three people playing at once */
           ...
           $('#'+row+'_'+column).click(function(r,c)
               {
                 return function()
                 {
                   ...
                   console.log('*** Client Log message: \'playtoken\' payload: '+JSON.stringify(payload));
