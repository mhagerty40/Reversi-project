...
/*Tell everyone that is already in the room that someone just joined */
   ...
   */
   ...
   /* payload:
    {
      'requested_user': The socekt id of the person to be invited
    }
    invite_response:
    {
      'result': 'success',
      'socket_id' :the socekt id of the person being invited
    }
    or
    {
      'result': 'fail',
    ...
    */
    ...
    /* payload:
     {
       'requested_user': The socekt id of the person to be uninvited
     }
     uninvite_response:
     {
       'result': 'success',
       'socket_id' :the socekt id of the person being uninvited
     }
     or
     {
       'result': 'fail',
     ...
     {
       'result': 'success',
       'socket_id' :the socekt id of the person being ininvited
     }
     or
     {
       'result': 'fail',
     ...
     */
     ...
     /* payload:
      {
          'requested_user': The socekt id of the person to play with
      }
      game_start_response:
      {
        'result': 'success',
      ...
      */
      ...
      socket.on('game_start',function(payload)
      {
        ...
        if(('undefined' === typeof username) || !username)
         {
          var error_message = 'game_start can\'t identify whoo sent the message, command aborted';
          log(error_message);
          socket.emit('game_start_response', {
                                               result: 'fail',
                                               message: error_message
